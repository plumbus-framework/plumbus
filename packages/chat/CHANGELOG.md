...
- Public chat protocol and configuration interfaces are unchanged. Model behavior can change because instruction roles and context framing are corrected. Deploy with core 0.6.20 for request-scoped RAG and prompt-substitution fixes. [Migration guide](../../docs/upgrading-security-release.md).
