...
import {
  ...
  type TransportProviderRegistration,
...
import type {
  ...
  LiveKitTransportProvider as LiveKitTransportProviderContract,
...
export { LIVEKIT_TRANSPORT_DESCRIPTOR };
