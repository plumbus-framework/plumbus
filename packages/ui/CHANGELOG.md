...
- Generated provider and request config wire the missing-message fallback helpers; generated config uses a literal `defaultLocale` (`as const satisfies Locale`) so `Messages` is not a locale union.
