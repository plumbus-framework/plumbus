...
describe("AI Explainability Tracker", () => {
  ...
  it("filters by prompt name", () => {
    const tracker = createExplainabilityTracker();
    tracker.record({ operation: "generate", promptName: "a", input: {}, output: null, latencyMs: 100 });
    tracker.record({ operation: "generate", promptName: "b", input: {}, output: null, latencyMs: 100 });
    tracker.record({ operation: "generate", promptName: "a", input: {}, output: null, latencyMs: 100 });
