import { z } from "zod";
import type { FlowDefinition, FlowRetryPolicy, FlowSchedule, FlowStep, FlowTrigger } from "../types/flow.js";
...
>(config: DefineFlowInput<TInput, TState>): FlowDefinition<TInput, TState> {
  if (!config.name) {
