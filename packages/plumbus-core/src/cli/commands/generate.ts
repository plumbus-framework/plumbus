...
import { info, resolvePath, success, toCamelCase, toKebabCase, toPascalCase, warn, writeFile } from "../utils.js";
...
export function registerGenerateCommand(program: Command): void {
  program
    .command("generate")
    .description("Generate derived artifacts from contracts (API clients, hooks, OpenAPI, manifest)")
